...
test.describe('Product Calculations', () => {
  ...
  test('Validation prevents calculation with missing fields', async ({ When, page, And, Then }) => { 
    await When('I select the "Assurance-Vie" product', null, { page }); 
    await And('I click "Continuer avec ce produit"', null, { page }); 
    await And('I fill the form with:', {"dataTable":{"rows":[{"cells":[{"value":"age"},{"value":"35"}]}]}}, { page }); 
    await And('I click "Calculer"', null, { page }); 
    await Then('I should still be on step 2', null, { page }); 
    await And('I should see an error message', null, { page }); 
  });
...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":42,"pickleLine":59,"tags":[],"steps":[{"pwStepLine":7,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"Given I am on the simulator page","isBg":true,"stepMatchArguments":[]},{"pwStepLine":43,"gherkinStepLine":60,"keywordType":"Action","textWithKeyword":"When I select the \"Assurance-Vie\" product","stepMatchArguments":[{"group":{"start":13,"value":"\"Assurance-Vie\"","children":[{"start":14,"value":"Assurance-Vie","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":44,"gherkinStepLine":61,"keywordType":"Action","textWithKeyword":"And I click \"Continuer avec ce produit\"","stepMatchArguments":[{"group":{"start":8,"value":"\"Continuer avec ce produit\"","children":[{"start":9,"value":"Continuer avec ce produit","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":45,"gherkinStepLine":62,"keywordType":"Action","textWithKeyword":"And I fill the form with:","stepMatchArguments":[]},{"pwStepLine":46,"gherkinStepLine":64,"keywordType":"Action","textWithKeyword":"And I click \"Calculer\"","stepMatchArguments":[{"group":{"start":8,"value":"\"Calculer\"","children":[{"start":9,"value":"Calculer","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":47,"gherkinStepLine":65,"keywordType":"Outcome","textWithKeyword":"Then I should still be on step 2","stepMatchArguments":[{"group":{"start":26,"value":"2","children":[]},"parameterTypeName":"int"}]},{"pwStepLine":48,"gherkinStepLine":66,"keywordType":"Outcome","textWithKeyword":"And I should see an error message","stepMatchArguments":[]}]},
  {"pwTestLine":51,"pickleLine":68,"tags":[],"steps":[{"pwStepLine":7,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"Given I am on the simulator page","isBg":true,"stepMatchArguments":[]},{"pwStepLine":52,"gherkinStepLine":69,"keywordType":"Context","textWithKeyword":"Given I have completed a calculation for \"Assurance-Vie\"","stepMatchArguments":[{"group":{"start":35,"value":"\"Assurance-Vie\"","children":[{"start":36,"value":"Assurance-Vie","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":53,"gherkinStepLine":70,"keywordType":"Action","textWithKeyword":"When I click \"Nouvelle simulation\"","stepMatchArguments":[{"group":{"start":8,"value":"\"Nouvelle simulation\"","children":[{"start":9,"value":"Nouvelle simulation","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":54,"gherkinStepLine":71,"keywordType":"Outcome","textWithKeyword":"Then I should be on step 1","stepMatchArguments":[{"group":{"start":20,"value":"1","children":[]},"parameterTypeName":"int"}]},{"pwStepLine":55,"gherkinStepLine":72,"keywordType":"Outcome","textWithKeyword":"And no product should be selected","stepMatchArguments":[]}]},
]; // bdd-data-end