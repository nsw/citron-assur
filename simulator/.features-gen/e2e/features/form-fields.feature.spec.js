...
test.describe('Dynamic Form Fields', () => {
  ...
  test('PER shows all fields', async ({ When, page, And, Then }) => { 
    ...
    await And('I click "Continuer avec ce produit"', null, { page }); 
    await Then('I should see all these fields:', {"dataTable":{"rows":[{"cells":[{"value":"age"}]},{"cells":[{"value":"sexe"}]},{"cells":[{"value":"statut"}]},{"cells":[{"value":"revenus"}]},{"cells":[{"value":"capital"}]},{"cells":[{"value":"versementsMensuels"}]},{"cells":[{"value":"ageRetraite"}]},{"cells":[{"value":"tauxRendement"}]}]}}, { page }); 
  });
...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":41,"pickleLine":44,"tags":[],"steps":[{"pwStepLine":7,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"Given I am on the simulator page","isBg":true,"stepMatchArguments":[]},{"pwStepLine":42,"gherkinStepLine":45,"keywordType":"Action","textWithKeyword":"When I select the \"Assurance-Vie\" product","stepMatchArguments":[{"group":{"start":13,"value":"\"Assurance-Vie\"","children":[{"start":14,"value":"Assurance-Vie","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":43,"gherkinStepLine":46,"keywordType":"Action","textWithKeyword":"And I click \"Continuer avec ce produit\"","stepMatchArguments":[{"group":{"start":8,"value":"\"Continuer avec ce produit\"","children":[{"start":9,"value":"Continuer avec ce produit","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]},{"pwStepLine":44,"gherkinStepLine":47,"keywordType":"Outcome","textWithKeyword":"Then I should see the help message \"L'assurance-vie n'est pas soumise aux plafonds de revenus\"","stepMatchArguments":[{"group":{"start":30,"value":"\"L'assurance-vie n'est pas soumise aux plafonds de revenus\"","children":[{"start":31,"value":"L'assurance-vie n'est pas soumise aux plafonds de revenus","children":[{"children":[]}]},{"children":[{"children":[]}]}]},"parameterTypeName":"string"}]}]},
]; // bdd-data-end